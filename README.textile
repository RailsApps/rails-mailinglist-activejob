h1. !http://railsapps.github.io/images/rails-36x36.jpg(Rails Mailing List Active Job)! Rails Mailing List Active Job

Rails 4.1 example application using "Active Job":https://github.com/rails/rails/tree/master/activejob for background processing. The application lets a visitor join a MailChimp-hosted mailing list.
...
* "Rails Mailing List Active Job":https://tutorials.railsapps.org/rails-mailinglist-activejob
